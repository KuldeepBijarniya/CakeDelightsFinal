...
await axios
      .post("https://cakedelights-backend.onrender.com/login", { email: email, otp: otp })
      ...
      <section className="containers m-auto">
        <div className="h-full w-full">
          <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            ...
            <div className="md:w-5/12 w-full flex flex-col text-center">
              <h1 className="my-12 text-black font-semibold text-3xl">
            Login
              </h1>
              <div
                className={`flex flex-row relative mb-4 ${
                  email ? "active" : ""
                }`}
              ...
              >
                ...
                <button onClick={mail}>&nbsp; Get OTP</button>
              ...
              <div
                className={`relative mb-6" ${otp ? "active" : ""}`}
                data-te-input-wrapper-init
              >
                <input
                  onChange={(event) => {
                  ...
                  type="text "
                  className={`w-10/12 peer block min-h-[auto]  rounded-xl ${
                    otp ? "border-primary" : "border-gray-300"
                  } border-2 bg-transparent px-3 py-[0.32rem] leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200`}
              ...
              <div className="text-center my-6 ">
                ...
                <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
                 Don't Have Account?
                  <Link
                    to="/signup"
                    className="text-danger text-rose-500 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
                  >
                    &nbsp; Register
                  </Link>
                </p>
