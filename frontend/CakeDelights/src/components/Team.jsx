...
export default function Team() {
  return (
    <section className="bg-rose-200 text-rose-800 ">
  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight text-rose-800 dark:text-white">Our team</h2>
          <p className="font-light text-rose-800 sm:text-xl dark:text-gray-400">Meet our crazy team</p>
      </div> 
